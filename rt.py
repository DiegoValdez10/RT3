...
from mathlib import normVector, dot, vectorNegative, subtractVectors, reflectVector, addVectors, addVectorScalar, \
    subtractVectorScalar, multVectorScalar, refractVector, totalInternalReflection, fresnel
